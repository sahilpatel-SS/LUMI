      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-80 flex-shrink-0 flex flex-col gap-4">
          ...
          <div className="sp-card p-5 flex items-center justify-between gap-4">
            <span className="text-2xl font-semibold text-dark">{skill.name}</span>
          ...
          <div className="sp-card p-5">
            <p className="text-sm font-semibold text-dark mb-2">Skill Description</p>
            <p className="text-sm font-normal text-muted leading-relaxed">{skill.description}</p>
          </div>
          ...
          {skill.evidence.length === 0 && (
            <p className="text-[15px] font-semibold text-dark">Supporting Evidence:</p>
          )}
        </div>
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          {skill.sessions.length > 0 ? (
            ...
            <div className="sp-card p-5">
              <p className="text-sm text-muted text-center py-4">No session feedback available yet.</p>
            </div>
          )}
        </div>
      </div>
